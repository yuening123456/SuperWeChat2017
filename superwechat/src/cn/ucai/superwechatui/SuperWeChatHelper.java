...
import cn.ucai.superwechatui.db.SuperWeChatManager;
...
import cn.ucai.superwechatui.domain.InviteMessage.InviteMesageStatus;
import cn.ucai.superwechatui.parse.UserProfileManager;
import cn.ucai.superwechatui.receiver.CallReceiver;
...
public class SuperWeChatHelper {
	...
	public void setContactList(Map<String, EaseUser> aContactList) {
		if(aContactList == null){
            Log.i("main","setContactList:"+contactList);
		    if (contactList != null) {
		        contactList.clear();
		    }
			return;
    ...
    public void updateAppContactList(List<User> contactInfoList) {
        Log.i("main","SuPerWeChatHelper.appContactList:"+appContactList);
...
*/
                   ...
                   userModel.downloadContactAllList(appContext, EMClient.getInstance().getCurrentUser(), new OnCompleteListener<String>() {
                       @Override
                       public void onSuccess(String s) {
                           if(s!=null){
